...
public class BookingClient extends BaseClient {
    ...
    public ResponseEntity<Object> bookingsApproved(Integer bookingId, Boolean approved, Integer userId) {
        Map<String, Object> parameters = Map.of(
                "bookingId", bookingId,
                "approved", approved
        );
    ...
    public ResponseEntity<Object> findAllForState(BookingState state, Integer userId) {
        Map<String, Object> parameters = Map.of(
                "state", state
        );
